...
namespace ItServiceApp.Controllers
{
    public class AccountController : Controller
    {
        ...
        {
            var user = await _userManager.FindByIdAsync(HttpContext.GetUser());
        ...
        public async Task<IActionResult> UpdatePassword(PasswordChangeViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                //return RedirectToAction(nameof(Logout)); // çıkış sayfasına yönlendirmek için yapılır
            }
            else
            {
        ...
        public async Task<IActionResult> ResetPassword(string email)
        {
            ...
            if(user== null)
            {
                ViewBag.Message = "Girdiğiniz email bulunmadı";
            }
            ...
            else
            {
                ...
                var emailMesssage = new EmailMessage()
                {
                    Contacts = new string[] { user.Email },
                    Body = $"Please reset yourpassword by <a href ='{HtmlEncoder.Default.Encode(callbackUrl)}'>Click Here<a/>",
                    Subject = "Reset Password"
                };
            await _emailSender.SendAsync(emailMesssage);
            ViewBag.Message = "Mailinize güncelleme gönderildi";
        ...
        public async Task< IActionResult> ConfirmResetPassword(ResetPasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                TempData["Message"] = "Sifre değişikliği oldu";
